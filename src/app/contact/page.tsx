      ...
      <section className="bg-navy py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Have a question or ready to get started? We are here to help.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="space-y-6">
              <div className="bg-gray-light rounded-[6px] p-6">
              ...
              <div className="bg-gray-light rounded-[6px] p-6">
                ...
                <p className="text-sm text-slate">Greater Houston Area, Texas</p>
              </div>
              <div className="bg-gray-light rounded-[6px] p-6">
                <Clock size={24} className="text-gold mb-3" />
                <h3 className="font-semibold text-navy mb-1">Response Time</h3>
                <p className="text-sm text-slate">Within 1 to 2 business days</p>
              </div>
            </div>
          </div>
        </div>
